...
include::Tickets/record-loading.adoc[]
...
include::Tickets/cataloguing-issues.adoc[]
...
include::ServerAdmin/organizational-units.adoc[]

Support Resources for Libraries
===============================

include::SupportResources/resources-for-libraries.adoc[]

include::SupportResources/updating-resources.adoc[]

include::SupportResources/resources-for-support.adoc[]
