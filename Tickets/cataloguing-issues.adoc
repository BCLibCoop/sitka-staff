...
Example situation: https://support.libraries.coop/rt/Ticket/Display.html?id=128398[RT 128398]
...
.. indicate we've made updates, and mention potential issues with patron holds
...
Example situation: https://support.libraries.coop/rt/Ticket/Display.html?id=129147[RT 129147]

. Check the lead record Record Notes tab to get the ID of records merged
. Ask Tina for audit log to determine which user merged the records
. Undelete the merged records
. Create a new ticket to notify the offending library
.. link to the original ticket (Refers to)
.. in the message to the library, include a link to cataloguing policy and mention potential issues with patron holds
.. provide details about how the cataloguing policy was violated
...
.. link to the original ticket (Refers to)
.. in the message to other libraries, include link to instructions for transferring holdings and mention potential issues with patron holds
