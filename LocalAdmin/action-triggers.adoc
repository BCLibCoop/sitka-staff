...
.Update templates to HTML

If the following code is included, notices will be sent as HTML:

* Content-Type: text/html; charset="utf-8"

Note that all content must be updated, particularly line breaks (i.e. &lt;br /&gt;), otherwise the text will be all stuck together on the same line. Another issue is that hyperlinks will no longer automatically link unless they are updated with HTML.
