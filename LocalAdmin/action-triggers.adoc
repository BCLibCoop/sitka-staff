...
Additionally, https://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references[numeric character references] must be used for some characters, e.g. if you want &lt; in the final notification, you should write &amp;lt&semi; in the template.
