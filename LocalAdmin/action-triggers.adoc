...
The hyphen should not touch the text (a space before and after it, - HTML rather than -HTML), and "HTML" should be written in all caps. This way, filtering by title anything that *Contains* _HTML_ means results should retrieve all templates updated to HTML.
