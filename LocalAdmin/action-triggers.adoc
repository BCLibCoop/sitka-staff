...
For example, line breaks need to be coded in (i.e. &lt;br /&gt;), otherwise the text will be all stuck together on the same line. Another issue is that hyperlinks will no longer automatically link unless they are updated with HTML, &lt;a href=&quot;hyperlink&quot;&gt;linked text&lt;/a&gt;
